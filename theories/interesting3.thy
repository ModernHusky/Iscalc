...
// Note: Cauchy Principle Value
prove (INT x:[-oo,oo]. cos(a * x) / (b ^ 2 - x ^ 2)) = pi * sin(a * b) / b for a b: real, a > 0, b > 0
lhs:
...
prove (INT x:[0,oo]. x * sin(a * x) / (x ^ 2 - b ^ 2)) = pi / 2 * cos(a * b) for a b: real, a > 0, b > 0
